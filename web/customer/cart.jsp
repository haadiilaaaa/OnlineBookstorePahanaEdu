...
<%
    ...
    // Get search and category data from request attributes
...
<div class="navbar">
    ...
    <form class="search-container" method="get" action="BookBrowseServlet">
            ...
            <%
                if (categories != null) {
                    for (ItemCategory category : categories) {
                        String selected = "";
                        if (selectedCategory != null && category.getId().equals(selectedCategory)) {
                            selected = "selected";
                        }
            %>
        ...
        <input type="text" class="search-box" name="keyword" placeholder="Search books by title/author" value="<%= searchKeyword != null ? searchKeyword : "" %>" />
    ...
    <nav class="nav-links" style="display: flex; font-weight: 700; align-items:end; font-size: 16px; color: var(--brown-dark);">
        ...
        <div class="account-cart dropdown">
            <span class="price">Rs. <%= total.toPlainString() %></span>
