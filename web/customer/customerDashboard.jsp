...
.dropdown {
  display: inline-block;
  position: relative; /* Make dropdown-content position relative to this */
}
...
<div class="navbar">
  ...
  <form class="search-container" method="get" action="BookBrowseServlet">
    ...
    <input type="text" class="search-box" name="search" placeholder="Search books by title/author" value="${searchKeyword}" />
...
<script>
  ...
  const targetCount = <%= dashboard != null ? dashboard.getCartItems().size() : 0 %>;
  let count = 0;
